...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'http://str-cafe-an.1gb.ru/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'http://str-cafe-an.1gb.ru/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'http://str-cafe-an.1gb.ru/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'http://str-cafe-an.1gb.ru/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'http://str-cafe-an.1gb.ru/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
			// Configuration related to container image box
			fitInWindow:			true,	// (boolean) If image bigger than screen size, container fit in window
		...
		function _show_image(intImageWidth, intImageHeight) {
			...
			$('#lightbox-image').attr({width: intImageWidth, height: intImageHeight});
